...
application { mainClass.set("com.squareup.francis.demo.MainKt") }
...
graalvmNative {
  binaries {
    named("main") {
      ...
      mainClass.set("com.squareup.francis.demo.MainKt")
    }
  }
}
...
tasks.jar {
  ...
  manifest { attributes("Main-Class" to "com.squareup.francis.demo.MainKt") }
