...
class DemoRunnerOptions(private val releaseDir: String, config: BaseConfig) :
  ...
  override val instrumentationApkOrNull: String? by lazy {
    super.instrumentationApkOrNull ?: "$releaseDir/demo-instrumentation.apk"
  }
  override val testSymbolOrNull: String? by lazy {
    super.testSymbolOrNull ?: "com.squareup.francis.demoinstrumentation.DemoBenchmark#startup"
  }
}
