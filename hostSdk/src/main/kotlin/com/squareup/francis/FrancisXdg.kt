...
object FrancisXdg {
  ...
  val francisData: File
    get() = File(Xdg.dataHome, APP_NAME)

  val francisConfig: File
    get() = File(Xdg.configHome, APP_NAME)

  val francisCache: File
    get() = File(Xdg.cacheHome, APP_NAME)
}
