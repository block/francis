...
object PerfettoConfig {
  /**
   * Default Perfetto trace config. Use [forPackage] or [forAllApps] to generate
   * a config with the appropriate atrace_apps setting.
   *
   * This matches the config used by the instrumentation SDK.
   */
